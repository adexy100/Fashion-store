[
    ...
    images: [
      {
        ...
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/tzfsnrli3szrdnb4jgge.jpg",
      },
    ],
    brand: "Ebay",
    stock: 50,
  ...
  },
  {
    ...
    images: [
      {
        public_id: "products/l2bd3hhy8dds1cxstuuz",
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231284/products/l2bd3hhy8dds1cxstuuz.jpg",
      },
    ],
    brand: "Amazon",
    stock: 0,
    ...
    images: [
      {
        ...
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/chairmount_nuubea.jpg",
      },
    ],
    brand: "Amazon",
    stock: 1,
    ...
    images: [
      {
        ...
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/airpords_e5cqqr.jpg",
      },
    ],
    brand: "Amazon",
    stock: 122,
    ...
    images: [
      {
        ...
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606233125/products/eahhtj1bkn1k9gjgd3hn.jpg",
      },
    ],
    brand: "Amazon",
    stock: 1123,
    ...
    images: [
      {
        ...
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/camera_ridc0i.jpg",
      },
    ],
    brand: "Amazon",
    stock: 131,
    ...
    images: [
      {
        ...
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/macbook_o2cj2k.jpg",
      },
    ],
    brand: "Amazon",
    stock: 0,
    ...
    images: [
      {
        ...
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/wmoa49q9e70ze9xtcra2.jpg",
      },
      {
        public_id: "products/i0k1wdwi5hrpmzwxvsds",
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/i0k1wdwi5hrpmzwxvsds.jpg",
      },
      {
        public_id: "products/bshmuo9qisfhz4azvnsd",
        url:
          "https://res.cloudinary.com/shopit/image/upload/v1606231282/products/bshmuo9qisfhz4azvnsd.jpg",
      },
    ],
    brand: "Kauffman's Fruit Farm & Market",
    stock: 500,
    numOfReviews: 1,
    reviews: [],
  },
